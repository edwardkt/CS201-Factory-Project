...
import gui.panels.subcontrolpanels.BreakPanel;
import gui.panels.subcontrolpanels.GlassInfoPanel;
import gui.panels.subcontrolpanels.GlassMakePanel;
...
public class ControlPanel extends JPanel implements TReceiver
{
	...
	/**
	 * A panel for making glass 
	 * Added by Christina
	 */
	GlassMakePanel glassMakePanel;
	
	/**
	 * A panel for breaking things
	 * Added by Christina
	 */
	...
	public ControlPanel()
	{
		...
		//Added by Christina
		glassMakePanel = new GlassMakePanel(this, bin);
		breakPanel = new BreakPanel(this);
	...
	public ControlPanel(FactoryPanel fPanel, Transducer fTransducer)
	{
		...
		parent = fPanel;
		nonNormPanel.setTransducer(fTransducer);
		breakPanel.setTransducer(fTransducer);
	}
	...
	public synchronized void eventFired(TChannel channel, TEvent event, Object[] args)
	{
		...
		if(channel==TChannel.CONTROL_PANEL && event==TEvent.START)
		{
	...
	public void setTransducer(Transducer newTransducer)
	{
		...
		transducer.register(this, TChannel.CONTROL_PANEL);
		transducer.register(this, TChannel.BIN);
		nonNormPanel.setTransducer(newTransducer);
	...
	{
		this.bin=bin;
		glassMakePanel.setBin(bin);
		System.out.println("bin was set");
	}
}
