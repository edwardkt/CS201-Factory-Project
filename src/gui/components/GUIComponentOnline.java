...
public class GUIComponentOnline extends GuiAnimationComponent implements ActionListener, Serializable, MouseListener
{
	...
	{
		if (counter < imageicons.size() * 4)
		{
			setIcon(imageicons.get(counter / 4));
			counter++;
		}
		else
		{
